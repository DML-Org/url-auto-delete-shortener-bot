...
BOT_TOKEN = environ.get('BOT_TOKEN', "5807907369:AAHMJeahoybEH1kx2D6AriRKhvfLkU6e8tY")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001593272391').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://dinukacreation:dinukacreation@cluster0.wz16kbc.mongodb.net/?retryWrites=true&w=majority")
